...
const NavMenuComp = (props) => {
  ...
  return <Navbar bg="light" expand="lg" className="nav-menu-comp sticky-top">
  <Container fluid>
    ...
    <Nav
      ...
      >
        ...
        <NavDropdown title="Shop" id="shopScrollingDropdown">
            <NavDropdown.Item as={NavLink} to="/products">Shop Category</NavDropdown.Item>
            <NavDropdown.Item as={NavLink} to="/details/5">Product Details</NavDropdown.Item>
        </NavDropdown> 


        <NavDropdown title="Pages" id="pagesScrollingDropdown">
            <NavDropdown.Item as={NavLink} to="/login">Login</NavDropdown.Item>
            <NavDropdown.Item as={NavLink} to="/tracking">Tracking</NavDropdown.Item>
            <NavDropdown.Item as={NavLink} to="/checkout">Product Checkout</NavDropdown.Item>
            <NavDropdown.Item as={NavLink} to="/cart">Shopping Cart</NavDropdown.Item>
        </NavDropdown>

        <NavDropdown title="Blog" id="blogScrollingDropdown">
            <NavDropdown.Item as={NavLink} to="/blog">Blog</NavDropdown.Item>
            <NavDropdown.Item as={NavLink} to="/blog/3">Simple Blog</NavDropdown.Item>
        </NavDropdown>
